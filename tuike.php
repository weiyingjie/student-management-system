...
$link=dbInit();
$sql='select * from course where course_id in (select course_id from `'.$_GET['stu_id'].'`);';
   ...
   <div class="tablebox">
      <table class="list" border=1>
         ...
         <tr>
				 ...
				 <td>
                    <span>
                        <img src="images/edt.gif" width="16" height="16" /><a href="<?php echo './tuike_data.php?stu_id='.$_GET['stu_id'].'&identify='.$_GET['identify'].'&course_id='.$row['course_id']; ?>">退课</a>
                    </span>
				</td>
			</tr>
         <?php endforeach; ?>
         <?php else: ?>
			<tr><td colspan="3">尚未选课</td></tr>
         <?php endif; ?>
      </table>
   </div>
   </div> 
